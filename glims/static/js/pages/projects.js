...
function ProjectController($scope,$http,DRFNgTableParams, FormlyModal, Project,projectService,growl) {
	...
	$scope.cols = {'Created':true,'ID':true,'Name':true,'Type':true,'Group':false,'Lab':true,'Manager':true,'Participants':false,'Description':true,'Contact':false,'Status':true,'Archived':false}
