...
#     permission_classes = [CustomPermission]
    ...
    model = Project
    filter_fields = {'project_id':['exact','icontains'],'name':['exact', 'icontains'], 'description':['exact', 'icontains'],'lab':['exact'],'type__name':['exact', 'icontains'],'group__id':['exact','in'],'archived':['exact'],'manager__last_name':['icontains'],'participants__last_name':['icontains'],'status__name':['icontains']}
