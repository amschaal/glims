...
#     referencing_projects = BasicProjectSerializer(many=True)
    ...
    class Meta:
        model = Project
        fields = ('id','type','subtype','name','sample_type','data','status_options','lab','group','manager','participants','related_projects','history','project_id','created','modified','description','contact','archived','status')
