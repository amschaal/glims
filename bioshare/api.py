...
#         return viewsets.ModelViewSet.create(self, request, *args, **kwargs)
    def create(self, request, *args, **kwargs):
        ...
        labshare = LabShare.objects.get_or_create(lab=project.lab,group=project.group) 
        data = {'project':request.data.get('project'),'folder':request.data.get('directory',project.name.replace(' ','_')),'labshare':labshare.id}
